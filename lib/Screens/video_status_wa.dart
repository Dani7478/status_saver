...
class VideoWhatsAppScreen extends StatefulWidget {
  String type;
  VideoWhatsAppScreen({Key? key, required this.type}) : super(key: key);

  @override
  State<VideoWhatsAppScreen> createState() => _VideoScreenState();
}

class _VideoScreenState extends State<VideoWhatsAppScreen> {
